    ...
    try {
        ...
        leads?.forEach(element => {
            let item = {
                ...
                "Project Name": element?.dataValues?.projectData?.dataValues?.project_name || '',
    ...
    try {
        ...
        visits?.forEach(element => {
            let item = {
                ...
                "Project Name": element?.dataValues?.leadData?.dataValues?.projectData?.dataValues?.project_name || '',
    ...
    try {
        ...
        bookings?.forEach(element => {
            let item = {
                ...
                "Project Name": element?.dataValues?.BookingprojectData?.dataValues?.project_name || '',
